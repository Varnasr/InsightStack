...
You enter:
- Total population
- Norm for access (e.g., 1 point per 2,000 people)
- Number of existing bank points (commercial, rural, ATMs, Bank Mitras)

The calculator compares required vs existing access points and shows whether the district has a surplus or gap.
